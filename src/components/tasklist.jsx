  ...
  // USHER - CLOSING ----------------------
   {
    ...
    tasks.push(new Task(
      ...
      "Wipe down the tables, the microwave, and the metal table the microwave is on. Empty out the trash and sweep and mop the break room area."
    ));

    tasks.push(new Task(
      "Usher", "Closing", "Closing",
      "Clean Compactor Area",
      "Ensure there is no trash around the compactor area. Mop if needed."
    ));

    tasks.push(new Task(
      "Usher", "Closing", "Closing",
      "Reline Hallway Trash, Restrooms, and Condiment Stand Trash",
      "Wipe down bullets and change any cans that are halfway filled or more. Reline all the condiment trash cans. Restroom trash can be relined if it is halfway filled or more."
    ));

    tasks.push(new Task(
      "Usher", "Closing", "Closing",
      "Stock All Chemical Stations & 3 Compartment Sink (If Needed)",
      "Ensure the chemical stations behind concessions and in closets 2 and 9 are fully stocked. Call a manager if a key is needed to open the cage up. This includes the soap and sanitizer that is connected to the 3 compartment sink behind concessions."
    ));

    tasks.push(new Task(
      "Usher", "Closing", "Closing",
      "Stock and Organize Usher Closets (No Clutter)",
      "Ensure the usher supply rack is stocked for the janitors and the next day."
    ));

    tasks.push(new Task(
      "Usher", "Closing", "Closing",
      "Wipe Down and Stock Condiment Stands",
      "Ensure the condiment stands are clean and well stocked."
    ));

    tasks.push(new Task(
      "Usher", "Closing", "Closing",
      "Reline Rolling Trash Cans for the Next Day",
      "Ensure all the rolling trash cans are emptied and relined for the next day."
    ));

    tasks.push(new Task(
      "Usher", "Closing", "Closing",
      "Take Trash Out",
      "Ensure the boats have been emptied and all trash is taken out."
    ));

    tasks.push(new Task(
      "Usher", "Closing", "Closing",
      "Mop from Loading Dock Doors to Concession Supply Closer",
      "Mop from the loading dock double doors to the washer and dryer."
    ));

    tasks.push(new Task(
      "Usher", "Closing", "Closing",
      "Ensure Lobby, Hallways, and Restrooms are Covered",
      "Keep an eye out on the lobby and hallways and do at least one restroom check after all shows have let out."
    ));

    tasks.push(new Task(
      "Usher", "Closing", "Closing",
      "Ensure All Auditoriums and Restrooms are Empty",
      "After everyone leaves, double check all the auditoriums that there are no guests. Check all rows and underneath the screen. Also, make sure the exit door(s) are shut."
    ));

    tasks.push(new Task(
      "Usher", "Closing", "Closing",
      "Empty Out the Popper",
      "Empty the popper of the popcorn and then take out the filter, bottom, and crumb catcher and place them on the dirty dish rack."
    ));

    tasks.push(new Task(
      "Usher", "Closing", "Closing",
      "Bring in A-Frame Signs",
      "Bring in the A-Frame signs and put them in the loading dock area near the boats and rolling trash cans."
    ));

    tasks.push(new Task(
      "Usher", "Closing", "Closing",
      "Clean Nozzles and Set Out to Dry",
      "Take the nozzles out of the K-5 solution and set them on a silver tray with paper towels underneath to dry for the night."
    ));

    tasks.push(new Task(
      "Usher", "Closing", "Closing",
      "Ensure All Exit Doors are Closed",
      "At the end of the night double check both the front and back exit doors and make sure they are closed."
    ));
    ...
    tasks.push(new Task(
      ...
      "Wipe down the door frame, threshold, and clean any cobwebs.",
      "Friday"
    ));
    ...
    tasks.push(new Task(
      "Usher", "Closing", "Weekly",
      "Trim Usher Brooks",
      "Use a pair of scissors and cut any of the out of place bristles on the brooms.",
      "Saturday"
    ));
    ...
    tasks.push(new Task(
      ...
      "Ensure there is no debris and thoroughly rinse out the mop buckets & sinks.",
      "Saturday"
    ));
    ...
    tasks.push(new Task(
      "Usher", "Closing", "Weekly",
      "Wash Out Butlers",
      "Gather all the butlers and wash them out with neutral cleaner and hot water. Set them out neatly to dry for the next day.",
      "Sunday"
    ));
    ...
    tasks.push(new Task(
      ...
      "Check the seat cleaning chart to see if there are any days or rows missed.",
      "Monday"
    ));
    ...
    tasks.push(new Task(
      ...
      "Take out each of the condiments/napkins/straws and clean out each container. Wipe down the counters, the cabinet doors, and inside the cabinets as well. Please also organize the cabinets.",
      "Tuesday"
    ));
    ...
    tasks.push(new Task(
      ...
      "Double check with all areas that no one has anything in the fridge or freezer before throwing out EVERYTHING in there. The only exceptions are if there is a name AND a future date. After the fridge/freezer is cleared out please wipe it down with sanitizer.",
      "Wednesday"
    ));
    ...
    tasks.push(new Task(
      ...
      "Wipe down the water fountains with sanitizer and pour hot water down."
    ));
    ...
    tasks.push(new Task(
      "Usher", "Closing", "Daily",
      "Clean and Stock Condiment Stands and Restrooms",
      "Ensure the condiment stands are clean and well stocked. Ensure there is no trash on the floors of the restrooms and that the counters & mirrors are water mark free."
    ));

    tasks.push(new Task(
      "Usher", "Closing", "Daily",
      "Wipe Down Exit Doors and Thresholds (Front and Back)",
      "Ensure there are no fingerprints on the glass doors and use metal shine/neutral cleaner to clean the door frames."
    ));

    tasks.push(new Task(
      "Usher", "Closing", "Daily",
      "Breakdown Standees",
      "If there are any standees in the back at the end of the night please double check if they are to be broken down and thrown away."
    ));
